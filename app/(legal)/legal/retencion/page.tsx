// ============================================================================
// /legal/retencion — Server Component puro, cero JavaScript de cliente.
//
...
// su propia versión y huella, generada desde la MISMA `POLITICA_RETENCION`)
// vive además en su ruta estática propia, `/legal/en/retencion`, enlazada
// bajo el título.
// ============================================================================
...
const documentoEn = DOCUMENTOS_LEGALES_EN['retencion']
