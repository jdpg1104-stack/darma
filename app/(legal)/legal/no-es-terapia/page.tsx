// ============================================================================
// /legal/no-es-terapia — Server Component puro, cero JavaScript de cliente.
//
...
// `/legal/en/no-es-terapia`, enlazada bajo el título.
// ============================================================================
...
const documento = DOCUMENTOS_LEGALES['no_es_terapia']
const documentoEn = DOCUMENTOS_LEGALES_EN['no_es_terapia']
...
export default function PaginaNoEsTerapia() {
