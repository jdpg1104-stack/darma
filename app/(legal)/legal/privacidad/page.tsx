// ============================================================================
// /legal/privacidad — Server Component puro, cero JavaScript de cliente.
//
...
// `/legal/en/privacidad`, enlazada bajo el título.
// ============================================================================
...
const documento = DOCUMENTOS_LEGALES['privacidad']
const documentoEn = DOCUMENTOS_LEGALES_EN['privacidad']
