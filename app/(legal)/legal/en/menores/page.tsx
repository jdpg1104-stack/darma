// ============================================================================
// /legal/en/menores — la versión INGLESA del documento. Server Component
...
const documento = DOCUMENTOS_LEGALES_EN['menores']
...
export default function PaginaMenoresEn() {
  return (
    <Documento
      documento={documento}
      locale="en"
      alterna={{ href: rutaDocumento('menores'), etiqueta: ETIQUETA_ORIGINAL_ES }}
    />
  )
}
