// ============================================================================
// /legal/en/retencion — la versión INGLESA del documento. Server Component
...
// cuerpo se GENERA desde la misma `POLITICA_RETENCION` que el español —la
// tabla de plazos no está duplicada, solo traducidas sus descripciones— y
// declara que el original español prevalece hasta la revisión legal externa.
// El chrome (etiquetas de versión y huella) va fijado a 'en'.
// ============================================================================
...
const documento = DOCUMENTOS_LEGALES_EN['retencion']
...
export default function PaginaRetencionEn() {
  return (
    <Documento
      documento={documento}
      locale="en"
      alterna={{ href: rutaDocumento('retencion'), etiqueta: ETIQUETA_ORIGINAL_ES }}
    />
  )
}
