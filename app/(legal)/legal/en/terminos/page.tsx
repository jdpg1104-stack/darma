// ============================================================================
// /legal/en/terminos — la versión INGLESA del documento. Server Component
...
export default function PaginaTerminosEn() {
  return (
    <Documento
      documento={documento}
      locale="en"
      alterna={{ href: rutaDocumento('terminos'), etiqueta: ETIQUETA_ORIGINAL_ES }}
    />
  )
}
