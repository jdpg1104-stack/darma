// ============================================================================
// /legal/en/privacidad — la versión INGLESA del documento. Server Component
...
const documento = DOCUMENTOS_LEGALES_EN['privacidad']
...
export default function PaginaPrivacidadEn() {
  return (
    <Documento
      documento={documento}
      locale="en"
      alterna={{ href: rutaDocumento('privacidad'), etiqueta: ETIQUETA_ORIGINAL_ES }}
    />
  )
}
